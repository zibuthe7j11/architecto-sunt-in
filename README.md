...
[![NPM version](https://img.shields.io/npm/v/@zibuthe7j11/architecto-sunt-in.svg)](https://www.npmjs.org/package/@zibuthe7j11/architecto-sunt-in)
...
You can easily include additional information in your error reports using the fluent [event builder API](https://github.com/zibuthe7j11/architecto-sunt-in/blob/master/packages/core/src/EventBuilder.ts).
...
[open an issue](https://github.com/zibuthe7j11/architecto-sunt-in/issues/new)
...
1. Clone this repository:
   ...
   ```sh
   git clone https://github.com/zibuthe7j11/architecto-sunt-in.git
   ```
...
[![contributors](https://contributors-img.web.app/image?repo=zibuthe7j11/architecto-sunt-in)](https://github.com/zibuthe7j11/architecto-sunt-in/graphs/contributors)
